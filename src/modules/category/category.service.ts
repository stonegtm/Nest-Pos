...
export class CategoryService {
  ...
  async findAll() {
    try {
      const find_category_all: any =
        await this.findAllCategoryService.execute();
  ...
  async create(category: CategoryDto) {
    try {
      const result_create_category =
        await this.addCategoryService.execute(category);
  ...
  async update(category: CategoryDto, id: string) {
    try {
      const result_update_category = await this.updateCategoryService.execute(
        category,
        id,
      );
